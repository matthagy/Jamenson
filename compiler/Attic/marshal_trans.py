...
from . import ir as I
from . import bind
from .walk import IRWalker, ReducingWalker, propigate_location
from .constants import collect_constants, ConstantsCollection
...
class MarshalTransformer(IRWalker):
    ...
    def visit_constant(self, cnst):
        if cnst.result_ignored:
            return
        if cnst.value not in self.constants:
            return
